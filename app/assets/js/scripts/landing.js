...
/**
 * News Loading Functions — disabled, news panel removed
 */

// Stub DOM refs to avoid null errors anywhere else
const newsContent                   = null
const newsArticleTitle              = null
const newsArticleDate               = null
const newsArticleAuthor             = null
const newsArticleComments           = null
const newsNavigationStatus          = null
const newsArticleContentScrollable  = null
const nELoadSpan                    = null

// News panel removed — stubs to prevent errors
let newsActive = false
let newsGlideCount = 0
function slide_(up){ /* news removed */ }

// News removed — all functions stubbed out
let newsArr = null
let newsAlertShown = false
let newsLoadingListener = null
function setNewsLoading(val){ /* news removed */ }
function reloadNews(){ return Promise.resolve() }
function showNewsAlert(){ /* news removed */ }
async function initNews(){ /* news removed */ }
function displayArticle(obj, idx){ /* news removed */ }
